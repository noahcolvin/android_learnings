...
private const val KEY_CURRENT_DESSERT = "current_dessert"
...
class MainActivity : AppCompatActivity(), LifecycleObserver {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (savedInstanceState != null) {
            ...
            currentDessert = allDesserts.find { it.imageId == savedInstanceState.getInt(KEY_CURRENT_DESSERT) } ?: allDesserts[0]
        }
    ...
    override fun onSaveInstanceState(outState: Bundle) {
        ...
        outState.putInt(KEY_CURRENT_DESSERT, currentDessert.imageId)
    }
}
